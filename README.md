...
**1.1.1 · Node.js 전용 · Steam 오프라인 5.0.2.0 / 빌드 25136512 기준**
...
워프툴 1.1.1-dev 이상은 M2G와 적용 순서가 바뀌어도 지원합니다. M2G 1.1.1에서는 M2G → 워프 적용 후에도 `상태 확인`이 정상적으로 나이프·워프 적용 상태를 표시합니다. 알려진 8개 조합의 전체 SHA-256과 EXE 해시 연결을 검증하며, 상태 인식 개선이 전체 백업 복원 제한을 해제하는 것은 아닙니다.
